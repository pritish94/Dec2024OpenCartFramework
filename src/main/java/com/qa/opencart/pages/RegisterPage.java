...
public class RegisterPage {
	...
	public boolean userRegistrationMethod(String firstName, String lastName, String telephone, String password,
			String subscribe) {
		...
		if (eleUtil.waitForElementVisible(successMessg, MEDIUM_DEFAULT_TIMEOUT).getText()
